    ...
    async function fetchBenchmarkData() {
      try {
        ...
        const formattedData: BenchmarkData = {
          traditional: {
            algorithm: trad.algorithm,
            mae: Number(trad.mae),
            rmse: Number(trad.rmse),
            r2: Number(trad.r2),
            f1Score: Number(trad.f1_score),
          },
          aiModel: {
            ...
            rmse: Number(ai.rmse),
            r2: Number(ai.r2),
            f1Score: Number(ai.f1_score),
          },
          comparisonMetrics: [
            { metric: 'MAE Delay (Months)', traditional: Number(trad.mae), aiModel: Number(ai.mae) },
            { metric: 'RMSE Error Variance', traditional: Number(trad.rmse), aiModel: Number(ai.rmse) },
            { metric: 'R² Goodness of Fit', traditional: Number(trad.r2), aiModel: Number(ai.r2) },
            { metric: 'F1 Classification Score', traditional: Number(trad.f1_score), aiModel: Number(ai.f1_score) },
          ],
        }
